...
|
|  Register prefix: registers are %-prefixed (%d0, %a1, ...), which
|  m68k-amiga-elf-as requires in its default (strict) mode. If you ever build
|  with an assembler configured for optional/no prefix, the % is still accepted.
| =============================================================================
